...
logger: Logger = logging.getLogger(name=f"{settings.LOG_PREFIX}_APP")
    ...
    def __init__(self) -> None:
        LGT_HEADERS: dict[str, dict[str, str]] = {
            "openrouter": {
                ...
                "X-Title": "Lorebook Gemini Translator",
            }
        }
        ...
        prompt_formatter = DefaultPromptFormatter(
            ...
            regen_prompt=self.REGEN_PROMPT,
        ...
        super().__init__(
            ...
            app_version_url=self.APP_VERSION_URL,
